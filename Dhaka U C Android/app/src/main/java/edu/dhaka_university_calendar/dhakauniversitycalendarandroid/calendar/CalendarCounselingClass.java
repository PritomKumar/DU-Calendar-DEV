...
public class CalendarCounselingClass extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Call<List<EventDay>> call = api.getCounselingCalendar();
...
/*
                ...
                final EventDecorator eventDecorator = new EventDecorator(Color.DKGRAY,calendarDayList);
            ...
            public void onFailure(Call<List<EventDay>> call, Throwable t) {
               // Toast.makeText(CalendarSportsClass.this, t.getMessage() , Toast.LENGTH_SHORT).show();
            }
        });
        ...
        textlist.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(CalendarCounselingClass.this, CalendarEventListActivity.class);
...
*/
        myCalendar.setOnDateChangedListener(new OnDateSelectedListener() {
            ...
            public void onDateSelected(@NonNull MaterialCalendarView widget, @NonNull CalendarDay date, boolean selected) {
                ...
                if(!events.isEmpty()) {
                    Intent intent = new Intent(CalendarCounselingClass.this, CalendarListViewEvent.class);
                    ...
                    Toast.makeText( CalendarCounselingClass.this, "No event today" , Toast.LENGTH_SHORT).show();
                }
