...
public class FacultyCommerceInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Call<List<Department>> call = api.getCommerceDepartments();
        ...
        call.enqueue(new Callback<List<Department>>() {
            ...
            public void onResponse(Call<List<Department>> call, Response<List<Department>> response) {
                ...
                DepartmentListAdapter departmentListAdapter = new DepartmentListAdapter(FacultyCommerceInfoActivity.this ,
                ...
                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                       ...
                       // Toast.makeText(FacultyScienceInfoActivity.this , departmentTemp.getName(),Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(FacultyCommerceInfoActivity.this , DepartmentViewActivity.class);
                ...
                for(Department d : departments){
                   ...
                   // Toast.makeText(FacultyCommerceInfoActivity.this, d.getName() , Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<List<Department>> call, Throwable t) {
               // Toast.makeText(FacultyCommerceInfoActivity.this, t.getMessage() , Toast.LENGTH_SHORT).show();
            }
        });
