...
public class TransportSrabon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Call<List<Transport>> call = api.getTransportSrabon();
        Call<List<Transport>> call = api.getTransportRetrofit("Srarbon");
        ...
        call.enqueue(new Callback<List<Transport>>() {
            ...
            public void onResponse(Call<List<Transport>> call, Response<List<Transport>> response) {
                ...
                TransportTableListAdapter adapter = new TransportTableListAdapter(TransportSrabon.this ,
