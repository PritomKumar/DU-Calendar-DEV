...
public class CalendarSportsClass extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Call<List<EventDay>> call = api.getSportsEventDays();
...
/*
                ...
                final EventDecorator eventDecorator = new EventDecorator(Color.MAGENTA,calendarDayList);
        ...
        textlist.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(CalendarSportsClass.this, CalendarSportsEventListActivity.class);
...
*/
        myCalendar.setOnDateChangedListener(new OnDateSelectedListener() {
            ...
            public void onDateSelected(@NonNull MaterialCalendarView widget, @NonNull CalendarDay date, boolean selected) {
                ...
                if(!events.isEmpty() ) {
                    Intent intent = new Intent(CalendarSportsClass.this, CalendarListViewEvent.class);
                    intent.putExtra("eventname", eventName.get(0));
                    Log.d("eventname" , eventName.get(0));
                    ...
                    Toast.makeText(CalendarSportsClass.this, "No event today" , Toast.LENGTH_SHORT).show();
                }
