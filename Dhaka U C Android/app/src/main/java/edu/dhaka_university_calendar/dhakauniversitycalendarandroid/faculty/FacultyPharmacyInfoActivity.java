...
public class FacultyPharmacyInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Call<List<Department>> call = api.getPharmacyDepartments();
        ...
        call.enqueue(new Callback<List<Department>>() {
            ...
            public void onResponse(Call<List<Department>> call, Response<List<Department>> response) {
                ...
                DepartmentListAdapter departmentListAdapter = new DepartmentListAdapter(FacultyPharmacyInfoActivity.this ,
                ...
                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                       ...
                       // Toast.makeText(FacultyScienceInfoActivity.this , departmentTemp.getName(),Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(FacultyPharmacyInfoActivity.this , DepartmentViewActivity.class);
                ...
                for(Department d : departments){
                   ...
                   // Toast.makeText(FacultyPharmacyInfoActivity.this, d.getName() , Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<List<Department>> call, Throwable t) {
              //  Toast.makeText(FacultyPharmacyInfoActivity.this, t.getMessage() , Toast.LENGTH_SHORT).show();
            }
        });
