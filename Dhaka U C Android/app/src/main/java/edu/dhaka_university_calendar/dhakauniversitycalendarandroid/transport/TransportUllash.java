...
public class TransportUllash extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Call<List<Transport>> call = api.getTransportUllash();
        Call<List<Transport>> call = api.getTransportRetrofit("Ullash");
        ...
        call.enqueue(new Callback<List<Transport>>() {
            ...
            public void onResponse(Call<List<Transport>> call, Response<List<Transport>> response) {
                ...
                TransportTableListAdapter adapter = new TransportTableListAdapter(TransportUllash.this ,
