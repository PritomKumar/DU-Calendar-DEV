...
import edu.dhaka_university_calendar.dhakauniversitycalendarandroid.information.DepartmentViewActivity;
...
public class FacultySocialScienceInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Call<List<Department>> call = api.getSocialScienceDepartments();
        ...
        call.enqueue(new Callback<List<Department>>() {
            ...
            public void onResponse(Call<List<Department>> call, Response<List<Department>> response) {
                ...
                DepartmentListAdapter departmentListAdapter = new DepartmentListAdapter(FacultySocialScienceInfoActivity.this ,
                ...
                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                       ...
                       // Toast.makeText(FacultyScienceInfoActivity.this , departmentTemp.getName(),Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(FacultySocialScienceInfoActivity.this , DepartmentViewActivity.class);
               ...
               //     Toast.makeText(FacultySocialScienceInfoActivity.this, d.getName() , Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<List<Department>> call, Throwable t) {
               // Toast.makeText(FacultySocialScienceInfoActivity.this, t.getMessage() , Toast.LENGTH_SHORT).show();
            }
        });
