...
public class HeadOfOfficesTableListAdapter extends ArrayAdapter<HeadOfOffice> {

    int vg;
    List<HeadOfOffice> fullCommittee;
    Context context;

    public HeadOfOfficesTableListAdapter(Context context , int vg , List <HeadOfOffice> fullCommittee){
    ...
    public View getView(int position , View convertView , ViewGroup parent){
        ...
        holder.txtname.setText(fullCommittee.get(position).getOfficName());
        holder.txtrank.setText(fullCommittee.get(position).getHeadName());
