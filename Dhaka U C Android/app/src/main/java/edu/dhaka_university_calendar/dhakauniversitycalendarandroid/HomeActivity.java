...
import edu.dhaka_university_calendar.dhakauniversitycalendarandroid.account.AccountActivity;
...
import edu.dhaka_university_calendar.dhakauniversitycalendarandroid.information.HeadOfDUInfoActivity;
...
public class HomeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        transport = findViewById(R.id.credits);
        head = findViewById(R.id.facilities);
