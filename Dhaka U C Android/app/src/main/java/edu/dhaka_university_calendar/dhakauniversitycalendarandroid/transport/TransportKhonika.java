...
public class TransportKhonika extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // Call<List<Transport>> call = api.getTransportKhonika();
        Call<List<Transport>> call = api.getTransportRetrofit("Khonika");
...
*/
                TransportTableListAdapter adapter = new TransportTableListAdapter(TransportKhonika.this ,
            ...
            public void onFailure(Call<List<Transport>> call, Throwable t) {
             //   Toast.makeText(TransportKhonika.this, t.getMessage() , Toast.LENGTH_SHORT).show();
            }
        });
    }
}
