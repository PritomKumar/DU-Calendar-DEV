...
public class TransportMoitree extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Call<List<Transport>> call = api.getTransportRetrofit("Maitree");
        ...
        call.enqueue(new Callback<List<Transport>>() {
            ...
            public void onResponse(Call<List<Transport>> call, Response<List<Transport>> response) {
                ...
                TransportTableListAdapter adapter = new TransportTableListAdapter(TransportMoitree.this ,
