...
public class InstitutesViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnMap.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent =  new Intent(InstitutesViewActivity.this  , MapActivityInfrastructure.class);
        ...
        Glide.with(InstitutesViewActivity.this).load(department.getImage())
