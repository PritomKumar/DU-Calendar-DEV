...
public class DULibraryViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dulibrary_view);
        ...
        Glide.with(DULibraryViewActivity.this).load(department.getImage())
