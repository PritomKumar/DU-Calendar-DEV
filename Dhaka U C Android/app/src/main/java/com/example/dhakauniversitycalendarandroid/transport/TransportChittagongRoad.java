...
public class TransportChittagongRoad extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Call<List<Transport>> call = api.getTransportRetrofit("Chittagong Road");
        ...
        call.enqueue(new Callback<List<Transport>>() {
            ...
            public void onResponse(Call<List<Transport>> call, Response<List<Transport>> response) {
                ...
                TransportTableListAdapter adapter = new TransportTableListAdapter(TransportChittagongRoad.this ,
