...
public class TransportBaishakhi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Call<List<Transport>> call =
        Call<List<Transport>> call = api.getTransportRetrofit("Baishakhi");
        ...
        call.enqueue(new Callback<List<Transport>>() {
            ...
            public void onResponse(Call<List<Transport>> call, Response<List<Transport>> response) {
                ...
                TransportTableListAdapter adapter = new TransportTableListAdapter(TransportBaishakhi.this ,
                        R.layout.transport_row_layout, transportList );
                listView.setAdapter(adapter);

                for(Transport d : transportList){
                    Log.d("id" , d.getId() );
                    Log.d("busname" , d.getBusName() );
            ...
            public void onFailure(Call<List<Transport>> call, Throwable t) {
             //   Toast.makeText(TransportBaishakhi.this, t.getMessage() , Toast.LENGTH_SHORT).show();
            }
        });
    }
}
